...
export declare function buildCredential(challenge: Challenge, agentId: string, token: string, paymentMethod: PaymentMethod, mobileNumber?: string, paymentMethodReferenceId?: string): Credential;
